...
const tutorial_html = `
    <div class="instruction">
        ...
        <ol start="1">
            ...
            <li>接受者决定将自己持有的一部分资金y元回报给投资者，0&nbsp≤&nbspx&nbsp≤&nbsp10+3x（y是整数），即接受者可以选择不回报投资者。此时投资者持有的资金为10-x+y元，而接受者持有的资金为10+3x-y元。</li>
        ...
        <ol class="example" start="1">
            ...
            <li>接受者回报给投资者8元，投资者持有18元，接受者持有17元。</li>
            <li>游戏结束，结算收益：投资者得到18元，接受者得到17元。</li>
        </ol>
    </div>
`
